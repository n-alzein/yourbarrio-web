...
const LOCATION_SELECT =
  "id,owner_user_id,public_id,business_name,business_type,category,city,state,postal_code,address,description,website,profile_photo_url,cover_photo_url,latitude,longitude,lat,lng,verification_status";
