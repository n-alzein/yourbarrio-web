...
function CategoryActionCue() {
  return (
    <span className="inline-flex h-[27px] w-[27px] shrink-0 items-center justify-center self-end rounded-full bg-white/90 text-[rgba(31,24,44,0.68)] ring-1 ring-black/[0.035] backdrop-blur transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.02] group-hover:bg-[rgba(244,240,249,0.92)] group-hover:text-[rgba(88,28,135,0.82)] group-focus-visible:scale-[1.02] group-focus-visible:bg-[rgba(244,240,249,0.92)] group-focus-visible:text-[rgba(88,28,135,0.82)]">
      <svg
        aria-hidden="true"
        viewBox="0 0 20 20"
        fill="none"
        ...
        <div className="py-12">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-6 lg:mx-auto lg:max-w-5xl lg:grid-cols-3 lg:gap-5">
            {FALLBACK_TILES.map((_, idx) => (
              ...
              >
                <div className="aspect-[3/4] w-full bg-black/[0.06] animate-pulse lg:aspect-[4/3]" />
            ...
            return (
              ...
              >
                <div className="relative aspect-[3/4] w-full overflow-hidden rounded-[inherit] bg-[linear-gradient(180deg,#d9c7b5_0%,#b59882_100%)] lg:aspect-[4/3]">
                  ...
                  />
                  <div className="theme-lock absolute bottom-4 left-4 right-20 z-10">
                    <h3
                      className="text-[15px] font-semibold leading-tight tracking-[-0.022em] text-white [text-wrap:balance] sm:text-base lg:text-[15px] xl:text-base"
